    ...
    <div class="hero-slider-viewport">
      <div class="hero-slider-track" id="heroSliderTrack">
        ...
        <article class="hero-slide hero-slide--media hero-slide--photo-center" aria-label="Slide 2 of 3" aria-hidden="true">
          ...
          <div class="hero-slide-scrim" aria-hidden="true"></div>
          <div class="hero-slide-inner">
            <p class="hero-eyebrow">Cutting &amp; heating</p>
            <h1>Everything your shop reorders, week after week</h1>
            <p class="tagline">Gas cutting, welding consumables, and industrial tools — specified clearly so you can request a quote with confidence.</p>
            <div class="hero-actions">
        ...
        <article class="hero-slide hero-slide--media hero-slide--photo-center" aria-label="Slide 3 of 3" aria-hidden="true">
          ...
          <div class="hero-slide-scrim" aria-hidden="true"></div>
          <div class="hero-slide-inner">
            <p class="hero-eyebrow">Welding &amp; fabrication</p>
            <h1>Welding that keeps production moving</h1>
            <p class="tagline">From electrodes to machines — we supply fabrication teams with genuine brands, clear specifications, and responsive support.</p>
            <div class="hero-actions">
              <a class="btn btn-primary" href="shop.html">Browse the catalog</a>
              <a class="btn btn-secondary" href="contact.html">Request a quote</a>
            </div>
    ...
    <div class="quotation-page-grid">
      <div class="prose quotation-instructions">
        ...
        <ol style="padding-left:1.25rem;line-height:1.7;color:var(--color-text-muted)">
          ...
          <li>Choose quantity (and enter any required specifications on the product page — for example capacity, or capacity and length where both apply).</li>
      ...
      <div class="quotation-form-card">
        ...
        <form id="quotationForm" class="quotation-form" novalidate>
          ...
          <div class="form-group">
            ...
            <textarea id="q_message" name="q_message" required rows="5" maxlength="4000" placeholder="Products, grades, sizes, quantities, capacity or other specs if machinery, timeline…"></textarea>
          </div>
