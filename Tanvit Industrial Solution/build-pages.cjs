...
pages["highlight.html"] =
  ...
  <div class="container section highlight-page-wrap highlight-page-wrap--marketing">
    <div class="highlight-toolbar highlight-toolbar--modern no-print" id="highlightToolbar" hidden>
      ...
      <div class="highlight-toolbar__row highlight-toolbar__row--secondary">
        <div class="highlight-toolbar__theme highlight-manual-picker-wrap">
          <label for="highlightProductSearch">Manual products</label>
          <input id="highlightProductSearch" class="highlight-toolbar__select" type="search" placeholder="Search product name, brand, category..." />
          <p id="highlightManualMeta" class="highlight-manual-meta">0 selected</p>
          <div id="highlightProductPicker" class="highlight-manual-list" aria-label="Manual product selection"></div>
        </div>
      </div>
