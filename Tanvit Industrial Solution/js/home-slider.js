(function () {
  ...
  /**
   * Initialise hero carousel. Called once after DOM is ready (static HTML or after site-loader injects slides).
   * Exposed as window.TanvitInitHeroSlider for js/site-loader.js.
   */
  function TanvitInitHeroSlider() {
  ...
  window.TanvitInitHeroSlider = TanvitInitHeroSlider;
})();
