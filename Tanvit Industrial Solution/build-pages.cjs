...
pages["shop.html"] =
  ...
  <div class="container section" style="padding-top:0">
    <div class="notice">Purchasing is by <strong>quotation and direct contact</strong> — there is no shopping cart. For stock, GST invoices, and delivery, use <a href="contact.html">Contact</a> or <a href="quotation.html">Get quotation</a>. See <code>docs/OPERATIONS.md</code> for how we run the site.</div>
